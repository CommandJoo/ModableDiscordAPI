package de.jo.modablediscord.events.api;
...
import de.jo.modablediscord.events.api.events.EventStoppable;
import de.jo.modablediscord.events.api.types.Priority;
...
public final class EventManager {
     ...
     * a new MethodData to key's matching list and sorts it based on Priority. @see de.jo.modablediscord.events.api.types.Priority
